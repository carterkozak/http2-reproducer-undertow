...
public final class Client {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // The OkHttp client leaks http/2 responses, frequently GC to avoid exhausting the connection pool.
            System.gc();
            // Depending on hardware, the 20ms duration may need to scale up or down. If too few requests are able to
